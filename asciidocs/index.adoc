...
----
docker run --name my-nginx -v /html/content:/usr/share/nginx/html -d nginx:1.21.6
docker image ls
docker stop my-nginx
docker container rm my-nginx
# sudo apt install nano
# nano start-nginx.sh
docker run --name my-nginx -v /html/content:/usr/share/nginx/html -d nginx:1.21.6 > start-nginx.sh
