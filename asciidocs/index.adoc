...
* wichtige Seiten im kapitel_3_1_Klassendiagramm.pdf

IMPORTANT: 1, 2, 3, 6, 8, 9, 10 ,11, 14, 16, 24, 29, 33, 35, 54, 60, 61, 71, 72, 73, 74, 79, 80, 81, 83, 84, 91, 92, 93, 94, 95, 97
...
Jedes Teammitglied geht nun in einen Branch, und implementiert dort das passende Feature passend zum Branchname aus.
Dies geht mithilfe folgendem Commandos:
...
Das Plugin "PlantUML integration" herunterladen und installieren.
...
.Beispiel Tennis (aus dem Unterricht)
== 2022-01-20
...
2 Objekte in PlantUML können mithilfe von Links miteinander verbunden werden.
Dies kann mit der Syntax <OBJEKT1> -- <OBJEKT2> erzeilt werden.
