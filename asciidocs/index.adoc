...
image::GET.jpeg[width=600]

image::POST.jpeg[width=600]

image::PUT.jpeg[width=600]

image::PATCH.jpeg[width=600]

image::DELETE.jpeg[width=600]
...
IMPORTANT: Es muss nicht für jede Entität ein eigenes Repository erstellt werden, sondern nur für starke Entitäten und den dazugehörigen schwachen Entitäten.
...
.assoziative Beziehungen auflösen
image::2022-05-19-board1.png[]

.database transaction
image::database-transactions.png[]

image::database-structure.png[]
